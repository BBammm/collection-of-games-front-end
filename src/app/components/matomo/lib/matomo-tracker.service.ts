...
export class MatomoTracker {
   ...
   */
  public trackSiteSearch(keyword: string, category?: string, resultsCount?: number): void {
    try {
   ...
   */
  public trackGoal(idGoal: number, customRevenue?: number): void {
    try {
   ...
   */
  public trackAllContentImpressions(): void {
    try {
   ...
   * @see {@link https://developer.matomo.org/guides/content-tracking|Content Tracking}
   */
  public trackVisibleContentImpressions(checkOnScroll: boolean, timeInterval: number): void {
    try {
   ...
   * @see {@link https://developer.matomo.org/guides/content-tracking|Content Tracking}
   */
  public trackContentImpressionsWithinNode(node: Node): void {
    try {
   ...
   * @see {@link https://developer.matomo.org/guides/content-tracking|Content Tracking}
   */
  public trackContentInteractionNode(node: Node, contentInteraction: string): void {
    try {
   ...
   * @see {@link https://developer.matomo.org/guides/content-tracking|Content Tracking}
   */
  public trackContentImpression(contentName: string, contentPiece: string, contentTarget: string): void {
    try {
   ...
   */
  public logAllContentBlocksOnPage(): void {
    try {
   ...
   */
  public enableHeartBeatTimer(delay: number): void {
    try {
   ...
   */
  public enableLinkTracking(enable: boolean): void {
    try {
   ...
   */
  public enableCrossDomainLinking(): void {
    try {
   ...
   * @see {@link https://matomo.org/faq/how-to/faq_23654/|Cross Domain Linking}
   */
  public setCrossDomainLinkingTimeout(timeout: number): void {
    try {
   ...
   * @see {@link https://matomo.org/faq/how-to/faq_23654/|Cross Domain Linking}
   */
  public setDomains(domains: string[]): void {
    try {
   ...
   */
  public setTrackerUrl(url: string): void {
    try {
   ...
   */
  public getPiwikUrl(): Promise<string> {
   ...
   */
  public setDownloadClasses(classes: string | string[]): void {
    try {
   ...
   */
  public setDownloadExtensions(extensions: string | string[]): void {
    try {
   ...
   * @param extensions Extension, or list of extensions to be recognized as downloads.
   */
  public addDownloadExtensions(extensions: string | string[]): void {
    try {
      window._paq.push(['setDownloadClasses', extensions]);
    } catch (e) {
      if (!(e instanceof ReferenceError)) {
   ...
   */
  public removeDownloadExtensions(extensions: string | string[]): void {
    try {
      window._paq.push(['setDownloadClasses', extensions]);
    } catch (e) {
      if (!(e instanceof ReferenceError)) {
   ...
   */
  public setIgnoreClasses(classes: string | string[]): void {
    try {
      window._paq.push(['setDownloadClasses', classes]);
    } catch (e) {
      if (!(e instanceof ReferenceError)) {
   ...
   */
  public setLinkClasses(classes: string | string[]): void {
    try {
      window._paq.push(['setDownloadClasses', classes]);
    } catch (e) {
      if (!(e instanceof ReferenceError)) {
   ...
   */
  public setLinkTrackingTimer(delay: number): void {
    try {
   ...
   */
 public getLinkTrackingTimer(): Promise<number> {
    return new Promise((resolve, reject) => {
      try {
        window._paq.push([
          function() {
   ...
   */
  public discardHashTag(value: boolean): void {
    try {
   ...
   */
  public setGenerationTimeMs(generationTime: number): void {
    try {
   ...
   */
  public appendToTrackingUrl(appendToUrl: string): void {
    try {
   ...
   */
  public setDoNotTrack(doNotTrack: boolean): void {
    try {
   ...
   */
  public redirectFile(url: string): void {
    try {
   ...
   */
  public setHeartBeatTimer(minimumVisitLength: number, heartBeatDelay: number): void {
    try {
   ...
   */
  public getVisitorInfo(): Promise<any[]> {
    return new Promise((resolve, reject) => {
      try {
        window._paq.push([
          function() {
   ...
   */
  public getAttributionInfo(): Promise<any[]> {
    return new Promise((resolve, reject) => {
      try {
        window._paq.push([
          function() {
   ...
   */
  public getAttributionCampaignName(): Promise<string> {
    return new Promise((resolve, reject) => {
      try {
        window._paq.push([
          function() {
   ...
   */
  public getAttributionCampaignKeyword(): Promise<string> {
    return new Promise((resolve, reject) => {
      try {
        window._paq.push([
          function() {
   ...
   */
  public getAttributionReferrerTimestamp(): Promise<string> {
    return new Promise((resolve, reject) => {
      try {
        window._paq.push([
          function() {
   ...
   */
  public getAttributionReferrerUrl(): Promise<string> {
    return new Promise((resolve, reject) => {
      try {
        window._paq.push([
          function() {
   ...
   */
  public setCustomVariable(index: number, name: string, value: string, scope: string): void {
    try {
   ...
   * @see {@link https://matomo.org/docs/custom-variables/|Custom Variables}
   */
  public deleteCustomVariable(index: number, scope: string): void {
    try {
   ...
   * @see {@link https://matomo.org/docs/custom-variables/|Custom Variables}
   */
  public deleteCustomVariables(scope: string): void {
    try {
   ...
   * @see {@link https://matomo.org/docs/custom-variables/|Custom Variables}
   */
  public getCustomVariable(index: number, scope: string): Promise<string> {
    return new Promise((resolve, reject) => {
      try {
        window._paq.push([
          function() {
   ...
   * @see {@link https://matomo.org/docs/custom-variables/|Custom Variables}
   */
  public storeCustomVariablesInCookie(): void {
    try {
   ...
   */
  public setCustomDimension(customDimensionId: number, customDimensionValue: string): void {
    try {
   ...
   * @see {@link https://plugins.piwik.org/CustomDimensions|Custom Dimensions}
   */
  public deleteCustomDimension(customDimensionId: number): void {
    try {
   ...
   * @see {@link https://plugins.piwik.org/CustomDimensions|Custom Dimensions}
   */
  public getCustomDimension(customDimensionId: number): Promise<string> {
    return new Promise((resolve, reject) => {
      try {
        window._paq.push([
          function() {
   ...
   */
  public setCampaignNameKey(name: string): void {
    try {
   ...
   * @see {@link https://matomo.org/docs/tracking-campaigns/|Campaigns}
   */
  public setCampaignKeywordKey(keyword: string): void {
    try {
   ...
   */
  public setConversionAttributionFirstReferrer(conversionToFirstReferrer: boolean): void {
    try {
   ...
   */
  public trackEcommerceCartUpdate(grandTotal: number): void {
    try {
   ...
   */
  public setCookieNamePrefix(prefix: string): void {
    try {
   ...
   */
  public setCookieDomain(domain: string): void {
    try {
   ...
   */
  public setCookiePath(path: string): void {
    try {
   ...
   */
  public setSecureCookie(secure: boolean): void {
    try {
   ...
   */
  public setVisitorCookieTimeout(timeout: number): void {
    try {
   ...
   */
  public setReferralCookieTimeout(timeout: number): void {
    try {
   ...
   */
  public setSessionCookieTimeout(timeout: number): void {
    try {
   ...
   */
  public addListener(element: Element): void {
    try {
   ...
   */
  public setCustomRequestProcessing(callback: (queryParameters: string) => void): void {
    try {
   ...
   */
  public setRequestContentType(contentType: string): void {
    try {
